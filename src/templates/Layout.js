                  ...
                  meta={[
                    {
                      name: "description",
                      content:
                        "DevOps with Kubernetes is a free MOOC created by the University of Helsinki where you can learn how to deploy, manage and monitor software in Kubernetes.",
                    },
                    {
                      name: "keywords",
                      content:
                        "DevOps, Kubernetes, MOOC, 2020, course, free, open, university, helsinki, helsingin yliopisto",
                    },
                  ]}
                />
                <Sidebar
